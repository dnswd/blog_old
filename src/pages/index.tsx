    ...
    <div className="relative">
      ...
      <main className="h-screen">
        <div className="absolute left-0 top-0 w-full">
          <header className="relative my-80 mx-auto w-screen-65">
          ...
          <section className="flex my-40-rem mx-auto w-screen-65 justify-between">
            <article className="flex flex-col gap-28 w-3/5 text-5xl">
            ...
            <div className="flex flex-col gap-16 w-1/5 text-xl">
